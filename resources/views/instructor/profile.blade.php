...
<script type="text/javascript">
    ...
    { 
        //image crop start
        $(".gambar").attr("src", @if(Storage::exists($instructor->instructor_image))"{{ url($instructor->instructor_image) }}" @else "{{ asset('backend/assets/images/course_detail.jpg') }}" @endif);
