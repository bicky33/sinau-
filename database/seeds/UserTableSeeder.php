...
class UserTableSeeder extends Seeder
{
  public function run()
  {
    ...
    if (!$is_exist->count()) {
        ...
        $student->last_name = 'anu';
        $student->email = 'student@sinau.com';
        ...
        $instructor_user->last_name = 'Yuk';
        $instructor_user->email = 'instructor@sinau.com';
        ...
        $instructor->last_name = 'Yuk';
        $instructor->instructor_slug = 'test-yuk';
        $instructor->contact_email = 'instructor@sinau.com';
        $instructor->telephone = '+61 (800) 123-54323';
        $instructor->mobile = '+61 800-1233-8766';
        $instructor->paypal_id = 'instructor@sinau.com';
